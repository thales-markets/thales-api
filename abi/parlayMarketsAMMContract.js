const parlayMarketsAMMContract = {
  addresses: {
    ...
    [8453]: "0x5625c3233b52206a5f23c5fC1Ce16F6A7e3874dd",
  },
  abi: [
    {
      anonymous: false,
    ...
    {
      anonymous: false,
      inputs: [{ indexed: false, internalType: "uint256", name: "parlaySize", type: "uint256" }],
    ...
    {
      anonymous: false,
      inputs: [{ indexed: false, internalType: "address", name: "parlayMarketMastercopy", type: "address" }],
    ...
    {
      anonymous: false,
      inputs: [{ indexed: false, internalType: "address", name: "parlayLP", type: "address" }],
      name: "ParlayLPSet",
      type: "event",
    },
    {
      ...
      inputs: [
        ...
        { indexed: false, internalType: "uint256[]", name: "marketQuotes", type: "uint256[]" },
      ],
    ...
    },
    {
      anonymous: false,
      inputs: [
        { indexed: false, internalType: "address", name: "_parlayMarket", type: "address" },
    ...
    },
    {
      ...
      inputs: [
        ...
        { indexed: false, internalType: "uint256", name: "_maxAllowedRiskPerCombination", type: "uint256" },
      ],
      name: "SetAmounts",
      type: "event",
    },
    ...
    },
    {
      anonymous: false,
      inputs: [
        { indexed: false, internalType: "uint256", name: "tag1", type: "uint256" },
        { indexed: false, internalType: "uint256", name: "tag2_1", type: "uint256" },
        { indexed: false, internalType: "uint256", name: "tag2_2", type: "uint256" },
        { indexed: false, internalType: "uint256", name: "fee", type: "uint256" },
      ],
      name: "SetSGPFeePerPosition",
      type: "event",
    },
    {
      anonymous: false,
      inputs: [{ indexed: false, internalType: "address", name: "sUSDToken", type: "address" }],
      name: "SetSUSD",
      type: "event",
    },
    {
      anonymous: false,
      inputs: [
        { indexed: false, internalType: "address", name: "_parlayVerifier", type: "address" },
        { indexed: false, internalType: "address", name: "_parlayPolicy", type: "address" },
      ],
      name: "VerifierAndPolicySet",
      type: "event",
    },
    {
      inputs: [
    ...
    },
    {
      inputs: [
        ...
        { internalType: "address", name: "_differentRecipient", type: "address" },
      ],
      name: "buyFromParlay",
      outputs: [],
    ...
    },
    {
      ...
      name: "exerciseParlayWithOfframp",
      outputs: [],
      stateMutability: "nonpayable",
      type: "function",
    },
    ...
    },
    {
      inputs: [
        ...
        { internalType: "uint256", name: "position1", type: "uint256" },
        { internalType: "uint256", name: "position2", type: "uint256" },
      ],
    ...
    },
    {
      inputs: [],
      name: "parlayVerifier",
      outputs: [{ internalType: "contract ParlayVerifier", name: "", type: "address" }],
      stateMutability: "view",
      type: "function",
    },
    {
    ...
    },
    {
      inputs: [
        ...
        { internalType: "uint256", name: "_maxAllowedRiskPerCombination", type: "uint256" },
      ],
      name: "setAmounts",
      outputs: [],
      stateMutability: "nonpayable",
    ...
    {
      inputs: [{ internalType: "uint256", name: "_parlaySize", type: "uint256" }],
      name: "setParameters",
      outputs: [],
      stateMutability: "nonpayable",
      type: "function",
    ...
    },
    {
      inputs: [
        ...
        { internalType: "uint256", name: "tag2_1", type: "uint256" },
        { internalType: "uint256", name: "tag2_2", type: "uint256" },
        { internalType: "uint256", name: "position_1", type: "uint256" },
        { internalType: "uint256", name: "position_2", type: "uint256" },
    ...
    },
    {
      inputs: [
        ...
        { internalType: "address", name: "_parlayPolicy", type: "address" },
      ],
      name: "setVerifierAndPolicyAddresses",
      outputs: [],
      stateMutability: "nonpayable",
      type: "function",
    },
