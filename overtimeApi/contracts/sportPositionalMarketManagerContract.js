...
const sportPositionalMarketManagerContract = {
  addresses: {
    [NETWORK.Optimism]: "0xFBffEbfA2bF2cF84fdCf77917b358fC59Ff5771e",
  ...
  abi: [
    ...
    {
      anonymous: false,
      inputs: [{ indexed: false, internalType: "address", name: "_sportPositionalMarketFactory", type: "address" }],
...
module.exports = sportPositionalMarketManagerContract;
