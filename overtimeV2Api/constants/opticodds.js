const OPTIC_ODDS_API_BASE_URL_V2 = "https://api.opticodds.com/api/v2";
const OPTIC_ODDS_API_BASE_URL_V3 = "https://api.opticodds.com/api/v3";

const OPTIC_ODDS_API_GAMES_URL = `${OPTIC_ODDS_API_BASE_URL_V2}/games`;
const OPTIC_ODDS_API_ODDS_URL = `${OPTIC_ODDS_API_BASE_URL_V2}/game-odds`;
const OPTIC_ODDS_API_SCORES_URL = `${OPTIC_ODDS_API_BASE_URL_V2}/scores`;
...
const OPTIC_ODDS_STREAM_ODDS_BASE_URL = `${OPTIC_ODDS_API_BASE_URL_V2}/stream/odds`;
